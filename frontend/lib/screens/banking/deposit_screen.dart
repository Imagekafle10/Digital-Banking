...
class _DepositScreenState extends State<DepositScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final transaction = await _bankingService.deposit(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.add_circle_rounded, color: AppColors.success),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Text(
                          'Adding money to ${widget.account.accountTypeLabel} '
